...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Kot Jojek\\IdeaProjects\\Music\\" + DB_NAME;
    ...
    public static final int ORDDER_BY_ASC = 2;
...
//    albums.name , song.track
    ...
    public void querySongsMetadata() {
        ...
        try (Statement statement = conn.createStatement();
            ...
            for (int i = 1; i <= numColumns; i++) {
                System.out.format("Column %d in the songs table in names %s\n",
    ...
    public boolean createViweForSongArtists() {
        try (Statement statement = conn.createStatement()) {
    ...
    private int insertArtist(String name) throws SQLException {
        ...
        if (results.next()) {
            ...
            if (affectedRows != 1) {
                System.out.println("Could not insert artist!");
            }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            System.out.println("Insert son exception: " + e.getMessage());
            try {
